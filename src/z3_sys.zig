...
/// Usage: link against libz3 and include z3.h headers
///
/// the initial version of this file was generated by claude sonnet 4.16
const std = @import("std");

// ============================================================
// Raw C FFI declarations (extern "c")
// ============================================================
...
fn checkError(ctx: *c.Z3_context) Error!void {
    const code = c.Z3_get_error_code(ctx);
    return switch (code) {
        .OK => {},
...
pub const Config = struct {
    ...
    pub fn init() Config {
        return .{ .raw = c.Z3_mk_config().? };
    }

    pub fn deinit(self: Config) void {
        c.Z3_del_config(self.raw);
    }

    pub fn set(self: Config, param: [:0]const u8, value: [:0]const u8) void {
        c.Z3_set_param_value(self.raw, param, value);
    }
};
...
pub const Context = struct {
    ...
    pub fn init(cfg: Config) Context {
        return .{ .raw = c.Z3_mk_context(cfg.raw).? };
    }

    /// Create a reference-counted context (use inc_ref/dec_ref on ASTs).
    pub fn initRc(cfg: Config) Context {
        return .{ .raw = c.Z3_mk_context_rc(cfg.raw).? };
    }

    pub fn deinit(self: Context) void {
        c.Z3_del_context(self.raw);
    }

    pub fn setErrorHandler(self: Context, handler: c.Z3_error_handler) void {
        c.Z3_set_error_handler(self.raw, handler);
    }

    // ---- Sorts ----
    pub fn boolSort(self: Context) Sort {
        return .{ .raw = c.Z3_mk_bool_sort(self.raw).?, .ctx = self.raw };
    }
    pub fn intSort(self: Context) Sort {
        return .{ .raw = c.Z3_mk_int_sort(self.raw).?, .ctx = self.raw };
    }
    pub fn realSort(self: Context) Sort {
        return .{ .raw = c.Z3_mk_real_sort(self.raw).?, .ctx = self.raw };
    }
    pub fn bvSort(self: Context, size: u32) Sort {
        return .{ .raw = c.Z3_mk_bv_sort(self.raw, @intCast(size)).?, .ctx = self.raw };
    }
    pub fn arraySort(self: Context, domain: Sort, range: Sort) Sort {
        return .{ .raw = c.Z3_mk_array_sort(self.raw, domain.raw, range.raw).?, .ctx = self.raw };
    }

    // ---- Constants ----
    pub fn boolConst(self: Context, name: [:0]const u8) Ast {
        const sym = c.Z3_mk_string_symbol(self.raw, name).?;
        const sort = c.Z3_mk_bool_sort(self.raw).?;
        return .{ .raw = c.Z3_mk_const(self.raw, sym, sort).?, .ctx = self.raw };
    }
    pub fn intConst(self: Context, name: [:0]const u8) Ast {
        const sym = c.Z3_mk_string_symbol(self.raw, name).?;
        const sort = c.Z3_mk_int_sort(self.raw).?;
        return .{ .raw = c.Z3_mk_const(self.raw, sym, sort).?, .ctx = self.raw };
    }
    pub fn realConst(self: Context, name: [:0]const u8) Ast {
        const sym = c.Z3_mk_string_symbol(self.raw, name).?;
        const sort = c.Z3_mk_real_sort(self.raw).?;
        return .{ .raw = c.Z3_mk_const(self.raw, sym, sort).?, .ctx = self.raw };
    }
    pub fn bvConst(self: Context, name: [:0]const u8, size: u32) Ast {
        const sym = c.Z3_mk_string_symbol(self.raw, name).?;
        const sort = c.Z3_mk_bv_sort(self.raw, @intCast(size)).?;
        return .{ .raw = c.Z3_mk_const(self.raw, sym, sort).?, .ctx = self.raw };
    }

    // ---- Literals ----
    pub fn mkTrue(self: Context) Ast {
        return .{ .raw = c.Z3_mk_true(self.raw).?, .ctx = self.raw };
    }
    pub fn mkFalse(self: Context) Ast {
        return .{ .raw = c.Z3_mk_false(self.raw).?, .ctx = self.raw };
    }
    pub fn mkInt(self: Context, v: i64) Ast {
        const sort = c.Z3_mk_int_sort(self.raw).?;
        return .{ .raw = c.Z3_mk_int64(self.raw, v, sort).?, .ctx = self.raw };
    }
    pub fn mkUnsignedInt(self: Context, v: u64) Ast {
        const sort = c.Z3_mk_int_sort(self.raw).?;
        return .{ .raw = c.Z3_mk_unsigned_int64(self.raw, v, sort).?, .ctx = self.raw };
    }
    pub fn mkReal(self: Context, num: i32, den: i32) Ast {
        return .{ .raw = c.Z3_mk_real(self.raw, @intCast(num), @intCast(den)).?, .ctx = self.raw };
    }
    pub fn mkNumeral(self: Context, s: [:0]const u8, sort: Sort) Ast {
        return .{ .raw = c.Z3_mk_numeral(self.raw, s, sort.raw).?, .ctx = self.raw };
    }

    // ---- Solver ----
    pub fn mkSolver(self: Context) Solver {
        const s = c.Z3_mk_solver(self.raw).?;
        c.Z3_solver_inc_ref(self.raw, s);
        return .{ .raw = s, .ctx = self.raw };
    }
    pub fn mkSolverForLogic(self: Context, logic: [:0]const u8) Solver {
        const sym = c.Z3_mk_string_symbol(self.raw, logic).?;
        const s = c.Z3_mk_solver_for_logic(self.raw, sym).?;
        c.Z3_solver_inc_ref(self.raw, s);
        return .{ .raw = s, .ctx = self.raw };
    }
    ...
    pub fn mkOptimize(self: Context) Optimize {
        const o = c.Z3_mk_optimize(self.raw).?;
        c.Z3_optimize_inc_ref(self.raw, o);
    ...
    pub fn getVersion() struct { major: u32, minor: u32, build: u32, revision: u32 } {
        ...
        c.Z3_get_version(&major, &minor, &build, &revision);
        return .{
            .major = @intCast(major),
            .minor = @intCast(minor),
            .build = @intCast(build),
...
pub const Sort = struct {
    ...
    pub fn toString(self: Sort) ?[*:0]const u8 {
        return c.Z3_sort_to_string(self.ctx, self.raw);
    }
    pub fn kind(self: Sort) c.Z3_sort_kind {
        return c.Z3_get_sort_kind(self.ctx, self.raw);
    }
};
...
pub const Ast = struct {
    ...
    pub fn toString(self: Ast) ?[*:0]const u8 {
        return c.Z3_ast_to_string(self.ctx, self.raw);
    }

    pub fn eql(self: Ast, other: Ast) bool {
        return c.Z3_is_eq_ast(self.ctx, self.raw, other.raw);
    }

    pub fn getSort(self: Ast) Sort {
        return .{ .raw = c.Z3_get_sort(self.ctx, self.raw).?, .ctx = self.ctx };
    }

    // Boolean ops
    pub fn not(self: Ast) Ast {
        return .{ .raw = c.Z3_mk_not(self.ctx, self.raw).?, .ctx = self.ctx };
    }
    pub fn @"and"(self: Ast, other: Ast) Ast {
        var args = [2]?*c.Z3_ast{ self.raw, other.raw };
        return .{ .raw = c.Z3_mk_and(self.ctx, 2, &args).?, .ctx = self.ctx };
    }
    pub fn @"or"(self: Ast, other: Ast) Ast {
        var args = [2]?*c.Z3_ast{ self.raw, other.raw };
        return .{ .raw = c.Z3_mk_or(self.ctx, 2, &args).?, .ctx = self.ctx };
    }
    pub fn implies(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_implies(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn iff(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_iff(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn xor(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_xor(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }

    // Arithmetic ops
    pub fn add(self: Ast, other: Ast) Ast {
        var args = [2]?*c.Z3_ast{ self.raw, other.raw };
        return .{ .raw = c.Z3_mk_add(self.ctx, 2, &args).?, .ctx = self.ctx };
    }
    pub fn sub(self: Ast, other: Ast) Ast {
        var args = [2]?*c.Z3_ast{ self.raw, other.raw };
        return .{ .raw = c.Z3_mk_sub(self.ctx, 2, &args).?, .ctx = self.ctx };
    }
    pub fn mul(self: Ast, other: Ast) Ast {
        var args = [2]?*c.Z3_ast{ self.raw, other.raw };
        return .{ .raw = c.Z3_mk_mul(self.ctx, 2, &args).?, .ctx = self.ctx };
    }
    pub fn div(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_div(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn mod(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_mod(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn neg(self: Ast) Ast {
        return .{ .raw = c.Z3_mk_unary_minus(self.ctx, self.raw).?, .ctx = self.ctx };
    }
    pub fn lt(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_lt(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn le(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_le(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn gt(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_gt(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn ge(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_ge(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn eq(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_eq(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }

    // Bit-vector ops
    pub fn bvadd(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvadd(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvsub(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvsub(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvmul(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvmul(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvand(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvand(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvor(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvor(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvxor(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvxor(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvnot(self: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvnot(self.ctx, self.raw).?, .ctx = self.ctx };
    }
    pub fn bvneg(self: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvneg(self.ctx, self.raw).?, .ctx = self.ctx };
    }
    pub fn bvshl(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvshl(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvlshr(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvlshr(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvashr(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvashr(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvult(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvult(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn bvslt(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_bvslt(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }
    pub fn extract(self: Ast, high: u32, low: u32) Ast {
        return .{ .raw = c.Z3_mk_extract(self.ctx, @intCast(high), @intCast(low), self.raw).?, .ctx = self.ctx };
    }
    pub fn concat(self: Ast, other: Ast) Ast {
        return .{ .raw = c.Z3_mk_concat(self.ctx, self.raw, other.raw).?, .ctx = self.ctx };
    }

    // Array ops
    pub fn select(self: Ast, idx: Ast) Ast {
        return .{ .raw = c.Z3_mk_select(self.ctx, self.raw, idx.raw).?, .ctx = self.ctx };
    }
    pub fn store(self: Ast, idx: Ast, val: Ast) Ast {
        return .{ .raw = c.Z3_mk_store(self.ctx, self.raw, idx.raw, val.raw).?, .ctx = self.ctx };
    }

    // Simplify
    pub fn simplify(self: Ast) Ast {
        return .{ .raw = c.Z3_simplify(self.ctx, self.raw).?, .ctx = self.ctx };
    }
};
...
pub const Model = struct {
    ...
    pub fn deinit(self: Model) void {
        c.Z3_model_dec_ref(self.ctx, self.raw);
    }

    pub fn toString(self: Model) ?[*:0]const u8 {
        return c.Z3_model_to_string(self.ctx, self.raw);
    }

    /// Evaluate an expression in the model. Returns null if evaluation fails.
    pub fn eval(self: Model, expr: Ast, completion: bool) ?Ast {
        var result: ?*c.Z3_ast = null;
        if (c.Z3_model_eval(self.ctx, self.raw, expr.raw, completion, &result)) {
    ...
    pub fn numConsts(self: Model) u32 {
        return @intCast(c.Z3_model_get_num_consts(self.ctx, self.raw));
    }
    pub fn numFuncs(self: Model) u32 {
        return @intCast(c.Z3_model_get_num_funcs(self.ctx, self.raw));
    }
};
...
pub const Solver = struct {
    ...
    pub fn deinit(self: Solver) void {
        c.Z3_solver_dec_ref(self.ctx, self.raw);
    }

    pub fn assert(self: Solver, expr: Ast) void {
        c.Z3_solver_assert(self.ctx, self.raw, expr.raw);
    }

    pub fn push(self: Solver) void {
        c.Z3_solver_push(self.ctx, self.raw);
    }

    pub fn pop(self: Solver, n: u32) void {
        c.Z3_solver_pop(self.ctx, self.raw, @intCast(n));
    }

    pub fn reset(self: Solver) void {
        c.Z3_solver_reset(self.ctx, self.raw);
    }

    pub fn check(self: Solver) CheckResult {
        return switch (c.Z3_solver_check(self.ctx, self.raw)) {
            .L_TRUE => .sat,
            .L_FALSE => .unsat,
            .L_UNDEF => .unknown,
        };
    ...
    pub fn checkAssumptions(self: Solver, assumptions: []const Ast) CheckResult {
        const ptrs = std.heap.page_allocator.alloc(?*c.Z3_ast, assumptions.len) catch return .unknown;
        defer std.heap.page_allocator.free(ptrs);
        for (assumptions, 0..) |a, i| ptrs[i] = a.raw;
        return switch (c.Z3_solver_check_assumptions(self.ctx, self.raw, @intCast(ptrs.len), ptrs.ptr)) {
            .L_TRUE => .sat,
            .L_FALSE => .unsat,
            .L_UNDEF => .unknown,
        };
    ...
    pub fn getModel(self: Solver) ?Model {
        const m = c.Z3_solver_get_model(self.ctx, self.raw) orelse return null;
        c.Z3_model_inc_ref(self.ctx, m);
        return .{ .raw = m, .ctx = self.ctx };
    }

    pub fn getUnsatCore(self: Solver) AstVector {
        const v = c.Z3_solver_get_unsat_core(self.ctx, self.raw).?;
        c.Z3_ast_vector_inc_ref(self.ctx, v);
        return .{ .raw = v, .ctx = self.ctx };
    }

    pub fn getReasonUnknown(self: Solver) ?[*:0]const u8 {
        return c.Z3_solver_get_reason_unknown(self.ctx, self.raw);
    }

    pub fn toString(self: Solver) ?[*:0]const u8 {
        return c.Z3_solver_to_string(self.ctx, self.raw);
    }

    pub fn numScopes(self: Solver) u32 {
        return @intCast(c.Z3_solver_get_num_scopes(self.ctx, self.raw));
    }
};
...
pub const Optimize = struct {
    ...
    pub fn deinit(self: Optimize) void {
        c.Z3_optimize_dec_ref(self.ctx, self.raw);
    }

    pub fn assert(self: Optimize, expr: Ast) void {
        c.Z3_optimize_assert(self.ctx, self.raw, expr.raw);
    }

    pub fn maximize(self: Optimize, expr: Ast) u32 {
        return @intCast(c.Z3_optimize_maximize(self.ctx, self.raw, expr.raw));
    }

    pub fn minimize(self: Optimize, expr: Ast) u32 {
        return @intCast(c.Z3_optimize_minimize(self.ctx, self.raw, expr.raw));
    }

    pub fn check(self: Optimize) CheckResult {
        return switch (c.Z3_optimize_check(self.ctx, self.raw, 0, undefined)) {
            .L_TRUE => .sat,
            .L_FALSE => .unsat,
            .L_UNDEF => .unknown,
        };
    ...
    pub fn getModel(self: Optimize) ?Model {
        const m = c.Z3_optimize_get_model(self.ctx, self.raw) orelse return null;
        c.Z3_model_inc_ref(self.ctx, m);
        return .{ .raw = m, .ctx = self.ctx };
    }

    pub fn getLower(self: Optimize, idx: u32) Ast {
        return .{ .raw = c.Z3_optimize_get_lower(self.ctx, self.raw, @intCast(idx)).?, .ctx = self.ctx };
    }

    pub fn getUpper(self: Optimize, idx: u32) Ast {
        return .{ .raw = c.Z3_optimize_get_upper(self.ctx, self.raw, @intCast(idx)).?, .ctx = self.ctx };
    }

    pub fn toString(self: Optimize) ?[*:0]const u8 {
        return c.Z3_optimize_to_string(self.ctx, self.raw);
    }
};
...
pub const AstVector = struct {
    ...
    pub fn deinit(self: AstVector) void {
        c.Z3_ast_vector_dec_ref(self.ctx, self.raw);
    }

    pub fn size(self: AstVector) u32 {
        return @intCast(c.Z3_ast_vector_size(self.ctx, self.raw));
    }

    pub fn get(self: AstVector, i: u32) Ast {
        return .{ .raw = c.Z3_ast_vector_get(self.ctx, self.raw, @intCast(i)).?, .ctx = self.ctx };
    }

    pub fn push(self: AstVector, a: Ast) void {
        c.Z3_ast_vector_push(self.ctx, self.raw, a.raw);
    }

    pub fn toString(self: AstVector) ?[*:0]const u8 {
        return c.Z3_ast_vector_to_string(self.ctx, self.raw);
    }
};
